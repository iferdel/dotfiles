---
name: git-gen-commit-msg
description: Generate a Conventional-Commit message and commit the currently staged changes. Use when asked to write a commit message or commit staged work.
---

Your task is to help the user generate a commit message and commit the changes using git.
